...
// Rewire uses mappings generated by Store.GetChangesetSpecRewireData to prepare the changeset rows
...
func (r *changesetRewirer) loadAssociations(ctx context.Context) (
	...
	changesetSpecMappings, err = r.tx.GetChangesetSpecRewireData(ctx, GetChangesetSpecRewireDataOpts{
		CampaignSpecID: r.campaign.CampaignSpecID,
